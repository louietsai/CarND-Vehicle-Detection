...
print("not cars len: ",len(notcars))
...
windows = windows_far + windows_middle + windows_close
...
def find_cars_orig(img, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins):
...
out_img = find_cars_orig(image, ystart, ystop, scale, svc, X_scaler, orient, pix_per_cell, cell_per_block, spatial_size, hist_bins)
print("after find_cars")
plt.imshow(out_img)
plt.show()
